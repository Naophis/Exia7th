...
void PID_Controller::step(const real32_T *arg_diff, const real32_T *arg_p_gain,
  ...
  pid_controller_DW.icLoad =
      ((((pid_controller_PrevZCX.UD_Reset_ZCE == POS_ZCSIG) !=
         *arg_reset_req) &&
  ...
  *arg_out = ((*arg_diff + pid_controller_DW.Integrator_DSTATE) +
              (rtb_UdiffTsProdOut - pid_controller_DW.UD_DSTATE)) *
             *arg_p_gain;
  pid_controller_DW.icLoad = false;
  pid_controller_DW.UD_DSTATE = rtb_UdiffTsProdOut;
  pid_controller_DW.Integrator_DSTATE +=
      *arg_diff * *arg_i_gain * *arg_dt * pid_controller_P.Integrator_gainval;
  pid_controller_DW.Integrator_PrevResetState =
...
PID_Controller::PID_Controller()
    : pid_controller_DW(), pid_controller_PrevZCX(), pid_controller_M() {}
